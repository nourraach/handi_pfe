  ...
  return (
    <div className="ht-landing" dir={dir}>
      ...
      <main className="ht-container ht-main">
        ...
        <section id="about" className="ht-section ht-about-section" aria-label="A propos de HandiTalents">
          <div className="ht-about-card">
            <div className="ht-about-copy">
              <span className="ht-section-kicker">A propos de HandiTalents</span>
              <h2>Votre partenaire pour la construction d un environnement de travail inclusif</h2>
              <p className="ht-about-subtitle">
                HandiTalents, propulsee par la startup HandiSuccess International, est la premiere plateforme de mise en relation dediee a la promotion de l inclusion professionnelle des personnes en situation de handicap.
              </p>
              <div className="ht-about-body">
                <p>
                  En partenariat avec Agence Nationale pour l Emploi et le Travail Independant (ANETI), nous connectons les employeurs engages en faveur de l inclusion avec des talents qualifies et motives, au sein d un environnement ou l accessibilite, l equite et la performance occupent une place centrale.
                </p>
                <p>
                  Grace a des solutions technologiques innovantes et a un accompagnement personnalise, nous aidons les entreprises a atteindre leurs objectifs en matiere de diversite et d inclusion, tout en accompagnant les candidats vers un emploi valorisant, durable et respectueux de leur dignite.
                </p>
                <p>
                  Notre plateforme accompagne egalement les entreprises de plus de 50 salaries dans le respect de la loi ndeg 41 de 2016, qui impose un quota de 2 % de personnes en situation de handicap au sein des effectifs des secteurs public et prive en Tunisie. Au dela de la conformite reglementaire, HandiTalents aide les organisations a batir une culture d entreprise veritablement inclusive, innovante et tournee vers l avenir.
                </p>
              </div>
            </div>

            <div className="ht-about-visual">
              <div className="ht-about-photo-frame">
                <Image
                  src="/about-handitalents.jpg"
                  alt="Signature de partenariat pour l inclusion professionnelle"
                  width={1200}
                  height={800}
                  className="ht-about-photo"
                />
              </div>
            </div>
          </div>
